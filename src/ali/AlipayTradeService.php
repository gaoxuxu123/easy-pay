...
namespace easy\pay\ali;


use easy\pay\ali\request\AlipayDataDataserviceBillDownloadurlQueryRequest;
use easy\pay\ali\request\AlipayTradeCloseRequest;
use easy\pay\ali\request\AlipayTradeFastpayRefundQueryRequest;
use easy\pay\ali\request\AlipayTradePagePayRequest;
use easy\pay\ali\request\AlipayTradePrecreateRequest;
use easy\pay\ali\request\AlipayTradeQueryRequest;
use easy\pay\ali\request\AlipayTradeRefundRequest;
...
class AlipayTradeService
{
    ...
    public function writeLog($text) {
        ...
        file_put_contents ( getcwd()."/log.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
    }
